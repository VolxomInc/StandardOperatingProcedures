...
public class GMPFileListAdapter extends ArrayAdapter<GMPFiles> implements Filterable{
    ...
    public GMPFileListAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<GMPFiles> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(
                    R.layout.list_view_folder_file, parent, false);
        }
    ...
    public void init_components(View view){
        imageView = (ImageView)view.findViewById(R.id.listViewFolderImageView);
        fileName = (TextView)view.findViewById(R.id.listViewFolderTextView);
    }
}
